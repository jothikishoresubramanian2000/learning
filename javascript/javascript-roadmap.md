...
## Phase 4.5 — Design Patterns — MOVED
> **Relocated 2026-08-27, on Kishore's request:** this phase now runs as the FINAL
> phase of `frontend-roadmap.md` (after its Phase 11), so backend and frontend pattern
> examples get learned together in one pass instead of backend-only here. See
> `frontend-roadmap.md`'s last phase for the full content.
